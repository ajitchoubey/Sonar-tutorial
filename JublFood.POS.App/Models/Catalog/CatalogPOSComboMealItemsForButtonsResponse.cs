...
{
    public class CatalogPOSComboMealItemsForButtonsResponse
    {
        public string ResponseStatus { get; set; }
        public string ResponseStatusCode { get; set; }
        public List<CatalogPOSComboMealItemsForButtons> catalogPOSComboMealItemsForButtons { get; set; }
    }
    public class CatalogPOSComboMealItemsForButtons
    {
